...
//
// Don't forget to pass these environment variables to any function that implements sessions,
// and to allow it to access the sessions table
//
...
function ensureSession(wrappedHandler) {
  return async (event, context) => {
    ...
    if (!status) {
      ...
      //
      // Call the wrapped handler with session information provided
      //
